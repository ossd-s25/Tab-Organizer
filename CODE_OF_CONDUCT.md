...
Some contributors may adopt additional project-specific guidelines, but all participants are expected to uphold these core principles.

---

## ⚖️ Resolving Conflicts Peacefully
...
If you see someone behaving disrespectfully, you are encouraged to address the behavior directly with those involved. Many issues can be resolved quickly and easily, and this gives people more control over the outcome of their dispute. If the behavior is consistently disruptive or inappropriate, it may impact participation in the project.

## 🌍 Scope

This Code of Conduct applies within all project spaces, including the GitHub repository, discussions, pull requests, and external communications related to the project.
...
Thank you for making Tab Organizer a friendly and inclusive space! 🚀
